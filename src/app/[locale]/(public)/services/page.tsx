...
export async function generateMetadata(
  ...
  if (locale === 'ar') {
    return {
      ...
      openGraph: { title: "خدماتنا | دار تشانغ", description: "توريد، فحص، رقابة جودة، ولوجستيات متكاملة.", url: "https://www.darchang.com/ar/services", locale: "ar_AE", type: "website", images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "دار تشانغ — خدمات التوريد" }] },
  ...
  return {
    ...
    openGraph: { title: "Our Services | Dar Chang", description: "Strategic sourcing, factory inspection, quality control & logistics from Shanghai.", url: "https://www.darchang.com/en/services", locale: "en_US", type: "website", images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Dar Chang — Sourcing & Logistics Services" }] },
